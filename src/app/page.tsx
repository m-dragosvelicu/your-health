...
import { LatestPost } from "~/app/_components/latest-post-panel";
        ...
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-8">
            ...
            <Link
              ...
              href="/companion"
            >
              <h3 className="text-2xl font-bold">Health Companion Landing →</h3>
              <div className="text-lg">
                Explore the new hero page showcasing OCR bloodwork, AI insights,
                meds tracking, and health metrics.
              </div>
            </Link>
          </div>
